                    ...
                    <div class="header-info">
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a
                                    href="tel:{{ $app ? $app->business_phone : '017555555555' }}">{{ $app ? $app->business_phone : '017555555555' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $app ? $app->business_email : 'admin@demo.com' }}">{{ $app ? $app->business_email : 'admin@demo.com' }}</a></span>
                        </div>
                        <div class="info-inner">
                ...
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-map-marker"
                                aria-hidden="true"></i>{{ $app ? $app->address : 'Dhaka, Bangladesh' }}
                        </p>
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i>{{ $app ? $app->business_email : 'admin@demo.com' }}
                        </p>
                        <p><i class="fa fa-phone"
                                aria-hidden="true"></i>{{ $app ? $app->business_phone : '01755555555' }}</p>
                    </div>
                </div>
                @livewire('subscribe')
            </div>
